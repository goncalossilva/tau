 ...
 * - breakdowns by model, working directory, weekday, and time of day
 *
 * Graph:
 * - GitHub-contributions-style calendar (weeks x weekdays) for model/cwd/time-of-day views
 * - Weekday distribution bars for the day-of-week view
 * - Hue: weighted mix of the active view colors (weighted by the selected metric)
